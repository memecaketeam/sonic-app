  ...
  reducers: {
    ...
    setValue: (
      ...
      if (
        ...
        const paths: any = getTokenPaths(
          allPairs as Pair.List,
          tokenList,
          metadata.id,
          state[data].value,
          data
    ...
    switchTokens: (state, action: PayloadAction<SwapTokenDataKey>) => {
      ...
      if (
        ...
        const oppositeTokenPaths = getTokenPaths(
          state.allPairs as Pair.List,
          state.tokenList,
          state[dataKey].metadata!.id,
          value,
          oppositeDataKey
        );
        ...
        const tokenPaths = getTokenPaths(
          state.allPairs as Pair.List,
          state.tokenList,
          state[oppositeDataKey].metadata!.id,
          oppositeValue,
          dataKey
        );
